...
const validateUserRegistration = [
  ...
  body('employment_type')
    ...
    .withMessage('Employment type must be one of: full-time, part-time, contract, intern'),
...
const validateLeaveRequest = [
  body('leave_type')
    ...
    .withMessage('Leave type must be one of: annual, sick, maternity, paternity, emergency, unpaid')
    .notEmpty()
